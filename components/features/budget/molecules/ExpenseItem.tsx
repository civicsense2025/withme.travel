...
import { ExpenseAmount } from '@/components/features/budget/atoms/ExpenseAmount';
import { ExpenseCategoryBadge, ExpenseCategory } from '@/components/features/budget/atoms/ExpenseCategoryBadge';
  ...
  return (
    ...
    >
      <div className="flex items-center gap-3">
        <ExpenseCategoryBadge category={category} className="text-sm" />
      ...
      <div className="flex items-center gap-3">
        ...
        <ExpenseAmount amount={amount} currency="USD" className="font-semibold" />
      </div>
    </div>
  );
}
