...
import { BudgetProgress } from '@/components/features/budget/atoms/BudgetProgress';
      ...
      <CardContent className="space-y-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="space-y-1">
            ...
            <ExpenseAmount amount={totalSpent} currency="USD" className="text-xl font-bold" />
          </div>
          <div className="space-y-1">
            ...
            <div className="space-y-2">
              {categoryTotals.map((category) => (
                <div key={category.category} className="flex justify-between items-center">
                  ...
                  <ExpenseAmount amount={category.amount} currency="USD" className="text-sm" />
                </div>
              ))}
            </div>
          </div>
