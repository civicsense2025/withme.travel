...
import { ItineraryItemCard } from '@/components/features/itinerary/atoms/ItineraryItemCard';
...
export function ItineraryDaySection({
  ...
  return (
    <div className="relative">
      ...
      {/* Connecting dashed line between sections */}
      {!isLastSection && (
        <div className="mx-auto w-px h-12 border-l-2 border-dashed border-muted-foreground/30 my-2"></div>
      )}
    </div>
  );
}
