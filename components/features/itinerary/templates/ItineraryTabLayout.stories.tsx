...
import { ItineraryTabLayout } from './ItineraryTabLayout';
import { addDays } from 'date-fns';

/**
 * Storybook stories for the ItineraryTabLayout template
 * Displays the main itinerary tab layout with scheduled and unscheduled items
 * @module features/itinerary/templates/ItineraryTabLayout
 */
const meta: Meta<typeof ItineraryTabLayout> = {
  title: 'Features/Itinerary/Templates/ItineraryTabLayout',
