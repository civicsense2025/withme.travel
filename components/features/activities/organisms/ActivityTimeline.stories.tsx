...
const sampleActivities = [
  ...
  },
  {
    ...
    entityType: 'trip',
    entityName: 'Italy Road Trip',
    timestamp: new Date(Date.now() - 7 * 24 * 60 * 60 * 1000).toISOString(),
  },
];

const meta: Meta<typeof ActivityTimeline> = {
  title: 'Features/Activities/Organisms/ActivityTimeline',
  ...
  argTypes: {
    activities: {
      control: 'object',
      description: 'Array of activity items to display in the timeline',
    },
    isLoading: {
      control: 'boolean',
      description: 'Whether the timeline is currently loading',
    },
    error: {
      control: 'text',
    ...
    groupByDay: {
      control: 'boolean',
      description: 'Whether to group activities by day',
    },
    showFilters: {
      control: 'boolean',
...
export const Empty: Story = {
  args: {
    ...
    hasMore: false,
    emptyStateMessage: 'No activities found in the timeline.',
  },
};
...
export const FilteredActivities: Story = {
  args: {
    activities: sampleActivities.filter(a => a.type === 'create'),
    isLoading: false,
    error: null,
    groupByDay: true,
    showFilters: true,
    filterState: {
      selectedTypes: ['create'],
      selectedEntities: [],
      dateRange: { start: null, end: null },
      userFilter: '',
    },
