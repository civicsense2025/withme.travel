...
export function CommandMenu() {
  ...
  const handleSelect = (value: string) => {
    ...
    console.log('[CommandMenu] Handle select action:', value, isLoggedIn ? 'Logged in' : 'Not logged in');
                ...
                {results.map((result: SearchResult) => (
                  ...
                  >
                    <div className="flex items-center w-full">
                      <p className="font-medium tracking-tight text-[hsl(var(--cmd-text))]">{result.title}</p>
                      {result.description && (
            ...
            {(!searchQuery || (!isLoading && results.length === 0)) && (
              <CommandGroup heading="Navigation" className="py-2 px-6">
                ...
                >
                  <div className="flex items-center w-full">
                    <div className="flex-1">
                      <p className="font-medium tracking-tight text-[hsl(var(--cmd-text))]">🗺️ Browse destinations</p>
                      <p className="text-sm text-[hsl(var(--cmd-text-muted))] mt-1">
                ...
                >
                  <div className="flex items-center w-full">
                    <div className="flex-1">
                      <p className="font-medium tracking-tight text-[hsl(var(--cmd-text))]">✈️ Plan a new trip</p>
                      <p className="text-sm text-[hsl(var(--cmd-text-muted))] mt-1">
                ...
                >
                  <div className="flex items-center w-full">
                    <div className="flex-1">
                      <p className="font-medium tracking-tight text-[hsl(var(--cmd-text))]">🧳 My trips</p>
                      <p className="text-sm text-[hsl(var(--cmd-text-muted))] mt-1">
                ...
                >
                  <div className="flex items-center w-full">
                    <div className="flex-1">
                      <p className="font-medium tracking-tight text-[hsl(var(--cmd-text))]">👥 My groups</p>
                      <p className="text-sm text-[hsl(var(--cmd-text-muted))] mt-1">
                ...
                >
                  <div className="flex items-center w-full">
                    <div className="flex-1">
                      <p className="font-medium tracking-tight text-[hsl(var(--cmd-text))]">⚙️ Settings</p>
                      <p className="text-sm text-[hsl(var(--cmd-text-muted))] mt-1">
                ...
                >
                  <div className="flex items-center w-full">
                    <div className="flex-1">
                      <p className="font-medium tracking-tight text-[hsl(var(--cmd-text))]">❤️ Support WithMe</p>
                      <p className="text-sm text-[hsl(var(--cmd-text-muted))] mt-1">
                ...
                >
                  <div className="flex items-center w-full">
                    <div className="flex-1">
                      <p className="font-medium tracking-tight text-[hsl(var(--cmd-text))]">🆘 Get help</p>
                      <p className="text-sm text-[hsl(var(--cmd-text-muted))] mt-1">
                ...
                {searchHistory.map((item: SearchHistoryItem) => (
                  ...
                  >
                    <div className="flex items-center w-full">
                      ...
                      <span className="tracking-tight flex-1 text-[hsl(var(--cmd-text))]">{item.query}</span>
                      <ChevronRight className="h-4 w-4 text-[hsl(var(--cmd-text-muted))] ml-3 flex-shrink-0" />
                    </div>
                  </CommandItem>
                ))}
