...
import { ActivityFilter, ActivityFilterItem } from '../molecules/activity-filter';
...
const DEFAULT_FILTER_OPTIONS: ActivityFilterItem[] = [
  ...
  { value: 'trip-created', label: 'Trip Created' },
  { value: 'trip-updated', label: 'Trip Updated' },
  { value: 'member-added', label: 'Member Added' },
  { value: 'member-removed', label: 'Member Removed' },
  { value: 'item-added', label: 'Item Added' },
  { value: 'expense-added', label: 'Expense Added' },
];
