      ...
      <div className="container flex h-16 items-center justify-between py-4">
        ...
        <div className="flex items-center gap-4">
          ...
          <Link href={user ? "/trips/create" : "/login?redirect=/trips/create"}>
            <Button className="lowercase rounded-full bg-travel-purple hover:bg-purple-400 text-purple-900 text-sm px-3 py-1 h-8">
          ...
          <button className="block md:hidden" onClick={toggleMenu} aria-expanded={isMenuOpen}>
      ...
      <AnimatePresence>
        {isMenuOpen && (
          <>
            ...
            {/* Mobile menu */}
            <motion.div
              className="fixed left-0 right-0 top-16 bottom-0 z-40 md:hidden border-t bg-background overflow-y-auto"
