...
export function SignupForm({
  ...
  return (
    ...
    >
      ...
      {/* Signup Form */}
      <motion.form onSubmit={handleSubmit} className="space-y-4" variants={slideUp} aria-label="Sign up form">
        {/* Name field */}
        ...
        <motion.div variants={fadeIn} className="space-y-2">
          <div className="flex items-start">
            ...
            <Label 
              htmlFor="terms" 
              className="text-xs text-muted-foreground ml-2 font-normal"
            >
              I agree to the&nbsp;
              <button 
                type="button"
