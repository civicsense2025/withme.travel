    ...
    <Card className="p-3 border border-dashed">
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-2">
        <div className="flex gap-2">
          ...
          <div>
            <label htmlFor="item-type" className="block text-sm font-medium text-muted-foreground mb-1">
              Item Type
            </label>
            <Select 
              ...
              disabled={isSubmitting}
            >
              <SelectTrigger className={`w-36 ${errors.item_type ? 'border-red-500' : ''}`} id="item-type">
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
  ...
  return (
    <Card className="p-3 border border-dashed">
      ...
      >
        ...
        <div className="mb-3">
          <label htmlFor="multi-item-type" className="block text-sm font-medium text-foreground mb-1">
            Item Type <span className="text-muted-foreground font-normal">(applied to all items)</span>
          </label>
          <Select 
            value={itemType}
          ...
          <p className="text-xs text-muted-foreground mt-1">All items will be added as <span className="font-medium">{itemType}</span> type</p>
        </div>
