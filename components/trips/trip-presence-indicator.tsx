    ...
    <TooltipProvider>
      <div className="bg-background/75 backdrop-blur-sm p-2 rounded-lg shadow-sm border border-border/10">
        ...
        <div className="flex items-center mb-1">
          ...
          <span className="text-xs ml-auto text-muted-foreground flex items-center">
          ...
          <TooltipContent side="bottom" align="end" className="max-w-xs p-3">
            ...
            <div className="space-y-2 max-h-60 overflow-y-auto">
              ...
              {usersByStatus.online.length > 0 && (
                <>
                  <p className="text-xs font-medium text-green-500 flex items-center mt-2">
              ...
              {usersByStatus.away.length > 0 && (
                <>
                  <p className="text-xs font-medium text-yellow-500 flex items-center mt-2">
              ...
              {activeUsers.length === 0 && (
                <p className="text-xs text-muted-foreground">No other users currently active.</p>
              )}
            </div>
          </TooltipContent>
        </Tooltip>
