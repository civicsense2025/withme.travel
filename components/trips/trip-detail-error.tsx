    ...
    <Card className="w-full max-w-2xl mx-auto shadow-md">
      ...
      <CardContent className="space-y-4">
        ...
        <div className="text-sm text-muted-foreground">
          ...
          {isPermissionDenied && (
            <p>
              You need to be invited to this trip to view it. Contact the trip
              owner if you believe you should have access.
            </p>
          )}

          {isNotFound && (
            <p>
              The trip you're looking for might have been deleted or never existed.
