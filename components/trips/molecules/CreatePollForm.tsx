 ...
 * Create Poll Form
 * 
 * A form for creating new polls/votes for trip decisions
 * 
...
// Poll form values type
type PollFormValues = z.infer<typeof pollSchema>;

// Props for the CreatePollForm component
export interface CreatePollFormProps {
  /** Trip ID to associate the poll with */
  tripId: string;
  /** Called after successful poll creation */
  onSuccess?: () => void;
...
/**
 * Form component to create a new poll
 */
