...
export function ViatorBookingTracker({ userId }: ViatorBookingTrackerProps) {
  ...
  const pendingBookings = bookings.filter(
    booking => booking.bookingStatus.status === 'pending'
  );
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-secondary-text">
          View and manage your tours and activity bookings
        </p>
      </div>
      ...
      <div className="flex flex-col sm:flex-row">
        ...
        <div className="flex flex-1 flex-col p-4">
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            ...
            {booking.bookingStatus.status === 'confirmed' && booking.bookingStatus.confirmationNumber && (
