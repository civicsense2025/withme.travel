        ...
        <div className="flex flex-1 flex-col p-4 lg:p-6">
          <div className="mb-4">
            ...
            <div className="mt-2 flex flex-wrap gap-2">
              {labels.map(label => (
                <Badge key={label} variant="outline" className="bg-accent-purple/5 text-xs dark:bg-accent-purple/10">
                  {label}
                </Badge>
              ))}
            </div>
            ...
            {isExpanded && (
              <p className="mt-4 text-sm text-secondary-text">{description}</p>
            )}
          </div>
            ...
            {booking.status === 'confirmed' ? (
              <div className="rounded-md bg-emerald-50 p-3 dark:bg-emerald-900/20">
                ...
                <div className="mt-2 flex flex-wrap gap-4 text-xs text-emerald-600 dark:text-emerald-300">
                  ...
                  {booking.bookedAt && (
                    <div>
                      <span className="font-medium">Booked:</span> {new Date(booking.bookedAt).toLocaleDateString()}
                    </div>
                  )}
                </div>
