...
export function MetadataEditorClient({ template }: MetadataEditorClientProps) {
  ...
  const [metadata, setMetadata] = useState<ItineraryTemplateMetadata>(
    template.metadata || {}
  );
  ...
  const updateBasicFields = () => {
    ...
    setJsonEditor(JSON.stringify(
      mergeMetadata(metadata, updatedMetadata), 
      null, 
      2
    ));
        ...
        <TabsContent value="basic" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Edit the most commonly used metadata fields
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Select 
                  ...
                  onValueChange={setAccessibilityLevel}
                >
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="Moderate - some uneven terrain or stairs">Moderate</SelectItem>
                    <SelectItem value="Difficult - challenging terrain or many stairs">Difficult</SelectItem>
                    <SelectItem value="Very difficult - not wheelchair accessible">Very Difficult</SelectItem>
                  </SelectContent>
                </Select>
              </div>
            ...
            <CardFooter>
              <Button onClick={updateBasicFields}>
                Apply Changes
              </Button>
            </CardFooter>
          </Card>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Load example metadata to use as a starting point
              </CardDescription>
            </CardHeader>
            <CardFooter className="flex justify-start space-x-2">
              <Button 
                variant="outline" 
                onClick={() => loadExample(COMPLETE_SAMPLE_METADATA)}
              >
                Complete Example
              </Button>
            </CardFooter>
        ...
        <TabsContent value="advanced">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Edit the raw JSON metadata structure
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Textarea 
              ...
              />
              {jsonError && (
                <p className="text-destructive mt-2 text-sm">{jsonError}</p>
              )}
            </CardContent>
            <CardFooter>
