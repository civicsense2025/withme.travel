...
/**
 * Content container for the Select dropdown options.
 *
 * @example
 * <Select>
  ...
  <SelectPrimitive.Portal>
    ...
    >
      <div className="sr-only">
        Press arrow keys to navigate options, Enter to select, Escape to close dropdown
      </div>
...
/**
 * Selectable item within a Select dropdown.
 *
 * @example
 * <SelectContent>
 *   <SelectItem value="option1">Option 1</SelectItem>
...
/**
 * Custom SelectValue component with placeholder support.
 *
 * @example
 * <SelectTrigger>
