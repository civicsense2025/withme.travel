 ...
 *
 * A flexible voting component for trips that shows options, vote counts,
 * and allows users to cast votes on different options.
 *
 * @module features/trips/organisms/TripVoting
 */
