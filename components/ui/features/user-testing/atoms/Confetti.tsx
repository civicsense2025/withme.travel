...
interface ConfettiProps {
  /** Width of the confetti area */
  width?: number;
  /** Height of the confetti area */
  height?: number;
  /** Number of confetti pieces to display */
  numberOfPieces?: number;
  /** Whether to recycle confetti pieces when they reach the bottom */
  recycle?: boolean;
  /** Array of colors for the confetti pieces */
  colors?: string[];
  /** Gravity factor (falling speed) */
  gravity?: number;
  /** Wind factor (horizontal movement) */
  wind?: number;
  /** Opacity of confetti pieces */
  opacity?: number;
 ...
 * Used for celebration and milestone completion animations
 */
