...
export const Secondary: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Secondary buttons are used for less important actions.',
      },
    },
  },
};
...
/**
 * The accent button style is used for highlighted actions.
 */
export const Accent: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Accent buttons are used for actions that need to stand out.',
      },
    },
  },
};
...
/**
 * The outline button style is used for secondary actions.
 */
export const Outline: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Outline buttons have a transparent background with a visible border.',
      },
    },
  },
};
...
export const FullWidth: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Full width buttons span the entire width of their container and are useful for mobile interfaces or when you want to emphasize an action.',
      },
    },
  },
};
...
export const Loading: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'The loading state can be used to indicate that an action is being processed. The button is automatically disabled when in loading state.',
      },
    },
  },
};
...
export const Disabled: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Disabled buttons are visually de-emphasized and do not respond to user interactions.',
      },
    },
  },
};
...
export const WithIcons: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Icons can be added to the left and/or right of button text to provide additional visual cues.',
      },
    },
  },
};
...
export const Interactive: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'This example demonstrates how a button can change its appearance based on user interaction.',
      },
    },
  },
};
...
export const DarkMode: Story = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        story:
          'Buttons automatically adapt their styling to maintain visibility and contrast in dark mode.',
      },
    },
  },
};
