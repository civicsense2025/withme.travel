      ...
      <DialogContent className="max-w-3xl max-h-[80vh] overflow-y-auto">
        ...
        <div className="prose dark:prose-invert max-w-none prose-sm py-4 pr-2">
          ...
          <section className="mt-6">
            ...
            <ul className="text-sm pl-5 list-disc space-y-1 mb-3">
              <li><strong>Who owns my content?</strong> You do. We only use it to provide and improve our services.</li>
              <li><strong>Do you sell my information?</strong> No, we never sell or share your personal info with marketers.</li>
              <li><strong>What happens if I break the rules?</strong> We may warn, restrict, or suspend your account depending on the severity.</li>
              <li><strong>How do I delete my account?</strong> Use account settings or email <a href="mailto:terms@withme.travel">terms@withme.travel</a>.</li>
              <li><strong>What third-party services do you use?</strong> Mapbox, Google Maps, Viator, Sentry, and Stripe for donations.</li>
              <li><strong>Does withme.travel handle payments?</strong> No, we only provide expense tracking tools. Payments are handled separately by users.</li>
            </ul>
          </section>
