        ...
        <div className="grid grid-cols-1 md:grid-cols-2">
          ...
          >
            ...
            <div className="relative z-10"> {/* Ensure content is above overlays */}
              <h2 className="text-2xl font-bold mb-4 text-white dark:text-white"> {/* Ensure text is visible */}
                tired of messy group travel?
              </h2>
              <p className="text-gray-200 dark:text-gray-300 mb-8"> {/* Adjust text color */}
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-3">
                  <Users className="h-6 w-6 text-primary mt-1 flex-shrink-0" /> {/* Added flex-shrink-0 */}
                  <div>
                    <h3 className="font-medium mb-1 text-white dark:text-white">everyone's actually involved</h3>
                    <p className="text-sm text-gray-200 dark:text-gray-300">share ideas, vote on plans, and keep the whole crew in sync (no more group chat chaos)</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <Heart className="h-6 w-6 text-primary mt-1 flex-shrink-0" /> {/* Added flex-shrink-0 */}
                  <div>
                    <h3 className="font-medium mb-1 text-white dark:text-white">save ideas for later</h3>
                    <p className="text-sm text-gray-200 dark:text-gray-300">spot something cool? bookmark it for your next trip instead of losing it forever</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <MapPin className="h-6 w-6 text-primary mt-1 flex-shrink-0" /> {/* Added flex-shrink-0 */}
                  <div>
                    <h3 className="font-medium mb-1 text-white dark:text-white">actually helpful local tips</h3>
                    <p className="text-sm text-gray-200 dark:text-gray-300">skip the tourist traps with insider recommendations that your group will love</p>
                  </div>
                </div>
              </div>
            </div>
