...
// Export a wrapper component for backwards compatibility
export function AuthModalWithProps({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) {
...
// Keep the default export for the main component
