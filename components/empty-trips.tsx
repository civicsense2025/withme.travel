          ...
          <div className="max-w-3xl mx-auto">
            ...
            >
              {quickStartDestinations.map((dest, index) => (
                <motion.div key={dest.name} variants={item}>
                  <Button
                    variant="ghost"
                    className={cn("h-auto w-full p-5 flex items-start gap-4 justify-start border rounded-xl transition-all hover:shadow-md", dest.color)}
            ...
            >
              <Link href={PAGE_ROUTES.CREATE_TRIP}>
                <Button size="lg" className="rounded-xl gap-2 px-8 bg-gradient-to-r from-travel-purple to-travel-blue hover:from-travel-purple/90 hover:to-travel-blue/90 transition-all shadow-md hover:shadow-lg group">
              ...
              <Link href="/destinations">
                <Button variant="outline" size="lg" className="rounded-xl gap-2 px-8 border-travel-purple/20 hover:bg-travel-purple/5">
