...
export const ITINERARY_TABLES = {
  ...
  ITINERARY_TEMPLATES: TABLES.ITINERARY_TEMPLATES,
  ITINERARY_TEMPLATE_SECTIONS: TABLES.ITINERARY_TEMPLATE_SECTIONS,
  ITINERARY_TEMPLATE_ITEMS: TABLES.ITINERARY_TEMPLATE_ITEMS,
