 ...
 */
export async function updateDestination(entityId: string, data: Record<string, any>): Promise<boolean> {
  try {
 ...
 * @returns A boolean indicating whether the update was successful
 */
export async function updateCountry(countryName: string, data: Record<string, any>): Promise<boolean> {
  try {
 ...
 * @returns A boolean indicating whether the update was successful
 */
export async function updateContinent(continentName: string, data: Record<string, any>): Promise<boolean> {
  try {
