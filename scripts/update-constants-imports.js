...
const IMPORT_MAPPINGS = [
  ...
  },
  {
    oldImport: '@/utils/constants',
    newImport: '@/utils/constants/api',
    constantName: 'DB_QUERIES',
  },
  {
    oldImport: '@/utils/constants',
    newImport: '@/utils/constants/api',
    constantName: 'QUERY_SNIPPETS',
  },
  ...
  },
  {
    oldImport: '@/utils/constants',
    newImport: '@/utils/constants/validation',
    constantName: 'SPLIT_TYPES',
  },
  {
    oldImport: '@/utils/constants',
    newImport: '@/utils/constants/validation',
    constantName: 'TRIP_TYPES',
  },
  {
    oldImport: '@/utils/constants',
    newImport: '@/utils/constants/validation',
    constantName: 'TEMPLATE_CATEGORIES',
  },
  {
    oldImport: '@/utils/constants',
    newImport: '@/utils/constants/validation',
    constantName: 'BUDGET_CATEGORIES',
  },
];
