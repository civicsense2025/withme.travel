...
import { ResearchStudy, ResearchTrigger, ResearchEvent, ResearchParticipant, Survey, SurveyResponse } from '@/types/research';
...
declare module '@supabase/supabase-js' {
  ...
  interface PostgrestQueryBuilder<T> {
    from(
      relation: typeof TABLES.RESEARCH_STUDIES | 
  ...
  interface PostgrestFilterBuilder<T> {
    ...
    insert<U extends Record<string, any>>(values: U | U[], options?: any): PostgrestFilterBuilder<T>;
