...
var NodeTypingsInstaller = class extends typescript_exports.server.typingsInstaller
  .TypingsInstaller {
  constructor(
    ...
    const libDirectory = (0, typescript_exports.getDirectoryPath)(
      (0, typescript_exports.normalizePath)(typescript_exports.sys.getExecutingFilePath())
    );
    super(
  ...
  installWorker(requestId, packageNames, cwd, onRequestCompleted) {
    ...
    const hasError = typescript_exports.server.typingsInstaller.installNpmPackages(
      this.npmPath,
