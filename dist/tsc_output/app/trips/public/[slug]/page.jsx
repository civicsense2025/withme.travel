...
export default function PublicTripPage(props) {
    ...
    const handleShare = () => {
        if (navigator.share) {
            navigator
                .share({
                title: (trip === null || trip === void 0 ? void 0 : trip.title) || "Check out this trip!",
                text: `Check out this trip: ${trip === null || trip === void 0 ? void 0 : trip.title}`,
    ...
    return (<div className="container py-6">
      ...
      <div className="flex flex-wrap gap-4 mt-6 mb-8">
        ...
        {trip.description && (<div className="flex items-center gap-1 text-sm">
        ...
        <TabsContent value="overview">
          <div className="grid md:grid-cols-2 gap-6 mt-6">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      {((_a = trip.description) === null || _a === void 0 ? void 0 : _a.replace("Trip to ", "")) || "Not specified"}
                    </p>
                  </div>
            ...
            : "Dates not set"}
                  ...
                  {((_b = trip.metadata) === null || _b === void 0 ? void 0 : _b.vibes) && trip.metadata.vibes.length > 0 && (<div>
                      <h3 className="font-medium">Trip Vibes</h3>
                      <div className="flex flex-wrap gap-2 mt-1">
                        {trip.metadata.vibes.map((vibe) => (<span key={vibe} className="bg-muted px-2 py-1 rounded-md text-xs">
                            {vibe}
                          </span>))}
                      </div>
                    </div>)}
