...
const LoadingShape = ({ className = "" }) => {
    return <div className={`absolute ${className} rounded-full animate-pulse bg-gray-200 dark:bg-gray-700`}/>;
};
export default function Loading() {
    return (<div className="container max-w-5xl pt-8 pb-20 relative overflow-hidden">
      {/* Decorative shapes */}
      ...
      <div className="lg:hidden mb-6 flex space-x-2">
        {[...Array(6)].map((_, i) => (<div key={i} className="w-8 h-8 rounded-full bg-gray-200 dark:bg-gray-700 animate-pulse"></div>))}
      </div>
