"use client";
import { Heart, Mail, MessageSquare, Instagram } from "lucide-react";
              ...
              <Card className="relative p-6 bg-card hover:bg-muted/50 transition-all duration-300">
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  <a href="https://venmo.com/u/ginandtanic" target="_blank" rel="noopener noreferrer">
                    <Button variant="outline" size="sm" className="h-auto px-2.5 py-1 border-travel-purple/50 text-travel-purple hover:bg-travel-purple/30 hover:text-travel-purple-foreground">
                      venmo
                    </Button>
                  </a>
                  ...
                  <a href="mailto:tanmho92@gmail.com?subject=withme.travel%20support%20%F0%9F%92%9C">
                    <Button variant="outline" size="sm" className="h-auto px-2.5 py-1 border-travel-purple/50 text-travel-purple hover:bg-travel-purple/30 hover:text-travel-purple-foreground flex items-center gap-1">
                ...
                <a href="https://instagram.com/ginandtanic" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-sm text-travel-purple hover:underline">
