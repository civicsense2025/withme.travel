...
export async function POST(request, { params }) {
    try {
        ...
        // If vote exists but different type, update it
            ...
            result = { action: "changed", voteType, vote: data === null || data === void 0 ? void 0 : data[0] };
        }
        // If no vote exists, create new one
            ...
            result = { action: "added", voteType, vote: data === null || data === void 0 ? void 0 : data[0] };
        }
        ...
        return NextResponse.json(Object.assign(Object.assign({}, result), { voteCount }));
    }
    catch (error) {
