...
async function checkTripAccess(supabase, tripId, userId, allowedRoles) {
    ...
    if (!member)
        return { allowed: false, error: "Not a member", status: 403 };
...
export async function POST(request, props) {
    ...
    try {
        ...
        const itemsToInsert = [];
        (_a = templateData === null || templateData === void 0 ? void 0 : templateData.template_sections) === null || _a === void 0 ? void 0 : _a.forEach(section => {
            var _a, _b;
            const dayNumber = (_a = section.day_number) !== null && _a !== void 0 ? _a : 1; // Default to day 1 if not specified
            (_b = section.template_activities) === null || _b === void 0 ? void 0 : _b.forEach((activity) => {
                var _a;
                itemsToInsert.push({
                    trip_id: tripId,
                    created_by: user.id,
                    ...
                    position: (_a = activity.position) !== null && _a !== void 0 ? _a : 0, // Use template position
        ...
        if (templateData === null || templateData === void 0 ? void 0 : templateData.version) {
            await supabase
        ...
        return NextResponse.json({ message: "Template applied successfully.", count: (_b = newItems === null || newItems === void 0 ? void 0 : newItems.length) !== null && _b !== void 0 ? _b : 0 }, { status: 200 });
    }
    catch (error) {
