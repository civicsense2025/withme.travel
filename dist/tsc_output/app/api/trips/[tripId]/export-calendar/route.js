...
export async function POST(request, { params }) {
    ...
    try {
        ...
        // Get itinerary items
        let query = supabase.from("itinerary_items").select("*").eq("trip_id", params.tripId);
        ...
        if (((_a = session.user.app_metadata) === null || _a === void 0 ? void 0 : _a.provider) !== "google") {
        ...
        const calendarEvents = (items === null || items === void 0 ? void 0 : items.map((item) => {
