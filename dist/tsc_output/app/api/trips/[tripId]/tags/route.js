...
export async function PUT(request, { params }) {
    ...
    try {
        ...
        const submittedTagIds = (upsertedTags === null || upsertedTags === void 0 ? void 0 : upsertedTags.map(tag => tag.id)) || [];
        ...
        const currentTagIds = (currentTripTags === null || currentTripTags === void 0 ? void 0 : currentTripTags.map(tt => tt.tag_id)) || [];
        ...
        const message = error instanceof Error ? error.message : 'An unexpected error occurred during tag synchronization';
