...
export async function updateSession(request) {
    ...
    try {
        ...
        if (error) {
            ...
            if (error.message !== 'Auth session missing!' && !((_a = error.message) === null || _a === void 0 ? void 0 : _a.includes("AuthSessionMissingError"))) {
        ...
        else if (process.env.NODE_ENV === 'development' && (data === null || data === void 0 ? void 0 : data.user)) {
