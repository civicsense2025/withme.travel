...
export function PermissionRequest({ tripId, tripName }) {
    ...
    return (<Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent>
        ...
        {isRequested ? (<div className="py-6 text-center">
            ...
            <div className="py-4">
              ...
              <Textarea placeholder="I'd like to help plan this trip by adding some activities I found..." value={message} onChange={(e) => setMessage(e.target.value)} className="min-h-[100px]"/>
            </div>
            <DialogFooter>
