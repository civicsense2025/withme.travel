...
export function RequestAccessDialog({ tripId }) {
    ...
    return (<Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent>
        ...
        {hasRequested ? (<div className="py-4 text-center">
            ...
            <div className="py-4">
              ...
              <Textarea id="message" placeholder="Let the organizers know why you'd like edit access..." value={message} onChange={(e) => setMessage(e.target.value)} className="min-h-[100px]"/>
            </div>
            <DialogFooter>
