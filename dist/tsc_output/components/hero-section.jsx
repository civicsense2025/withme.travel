...
export function HeroSection() {
    ...
    return (<div className="relative py-16 md:py-24 px-3 sm:px-6 lg:px-8 flex flex-col items-center justify-center text-center">
      ...
      <div className="w-full max-w-xl animate-fade-in-up px-2 md:px-0 mb-4" style={{ animationDelay: "0.2s" }}>
        <div className="flex flex-col md:flex-row gap-3">
          <LocationSearch onLocationSelect={handleLocationSelect} placeholder="where to? try 'barcelona' or 'tokyo'" className="rounded-full py-3" containerClassName="flex-1"/>
          <Button className="lowercase px-8 py-3 rounded-full h-auto w-full md:w-auto" onClick={handleExploreClick}>
