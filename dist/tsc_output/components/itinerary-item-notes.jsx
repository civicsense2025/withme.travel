...
export function ItineraryItemNotes({ tripId, itemId, initialContent = '', readOnly = false, onSave }) {
        ...
        const getUser = async () => {
            ...
            if (user) {
                ...
                setCurrentUser({
                    ...
                    avatar: (profile === null || profile === void 0 ? void 0 : profile.avatar_url) || `/api/avatar?name=${encodeURIComponent((profile === null || profile === void 0 ? void 0 : profile.name) || 'User')}`
                });
            }
            setIsLoaded(true);
        };
    ...
    return (<div className="space-y-2">
      ...
      {!readOnly && (<div className="flex justify-end">
          <Button onClick={saveContent} size="sm" disabled={isSaving}>
