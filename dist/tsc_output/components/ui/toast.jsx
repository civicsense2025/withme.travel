...
import { toastAnimation } from "@/utils/animation";
...
const toastVariants = cva("group pointer-events-auto relative flex w-full items-center justify-between space-x-4 overflow-hidden rounded-md border p-6 pr-8 shadow-lg transition-all data-[swipe=cancel]:translate-x-0 data-[swipe=end]:translate-x-[var(--radix-toast-swipe-end-x)] data-[swipe=move]:translate-x-[var(--radix-toast-swipe-move-x)] data-[swipe=move]:transition-none", {
    variants: {
        variant: {
...
const Toast = React.forwardRef((_a, ref) => {
    ...
    return (<motion.div initial="hidden" animate="visible" exit="exit" variants={toastAnimation}>
