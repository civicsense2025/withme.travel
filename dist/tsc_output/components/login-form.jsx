...
export function LoginForm() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Redirect after successful login using the decoded path
    ...
    return (<motion.div className="space-y-6" initial="hidden" animate="visible" variants={staggerContainer}>
      <motion.div variants={fadeIn}>
        <Button type="button" variant="outline" className="w-full flex items-center gap-2 h-10 lowercase" onClick={handleGoogleSignIn} disabled={isLoading}>
      ...
      <motion.form onSubmit={handleSubmit} className="space-y-4" variants={slideUp}>
        <motion.div variants={fadeIn} className="space-y-2">
          ...
          <Input id="email" name="email" type="email" placeholder="hello@example.com" value={formData.email} onChange={handleChange} required/>
        </motion.div>
        <motion.div variants={fadeIn} className="space-y-2">
