...
export function TravelSquadScreen({ userData, onInputChange, onNext, onBack, onSkip }) {
    const squads = [
        ...
        { id: "coworkers", label: "coworkers", icon: Briefcase, description: "Mixing business & pleasure" },
        { id: "mixed", label: "mixed crew", icon: UserPlus, description: "Different groups, different trips" },
    ];
      ...
      <CardContent className="pt-6 pb-8 px-6">
        ...
        <div className="space-y-3 mb-6">
          {squads.map((squad) => {
            ...
            return (<Button key={squad.id} variant={userData.travelSquad === squad.id ? "default" : "outline"} className="w-full justify-start text-left py-6 px-4 group" onClick={() => onInputChange("travelSquad", squad.id)}>
