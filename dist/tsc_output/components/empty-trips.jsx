        ...
        <CardContent className="p-8 md:p-12">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-4 mb-8">
              {quickStartDestinations.map((dest) => (<Button key={dest.name} variant="outline" className="h-auto p-4 flex items-start gap-3 bg-background/80 backdrop-blur-sm hover:bg-background/90" onClick={() => handleQuickStart(dest.destination)}>
