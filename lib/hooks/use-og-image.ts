...
export function getGenericThumbnailUrl({
  ...
  const url = new URL('/api/thumbnail', process.env.NEXT_PUBLIC_SITE_URL || 'https://withme.travel');
...
export function getTripThumbnailUrl({
  ...
  const url = new URL(`/api/thumbnail/trip`, process.env.NEXT_PUBLIC_SITE_URL || 'https://withme.travel');
...
export function getDestinationThumbnailUrl({
  ...
  const url = new URL(`/api/thumbnail/destination`, process.env.NEXT_PUBLIC_SITE_URL || 'https://withme.travel');
 ...
 */
export function getOpenGraphImageForDestination(params: DestinationThumbnailParams): OpenGraphImage[] {
...
export function useOpenGraphImage(
  params: 
    ...
    | { type: 'destination'; destinationId?: string; city?: string; country?: string; imageUrl?: string; description?: string }
