...
export const ideasWhiteboardTour: TourConfig = {
  ...
  steps: [
    ...
    },
    {
      ...
      content: 'See what others are doing in real-time! Their cursors show exactly what they\'re working on.',
    ...
    },
    {
      id: 'voting-button',
      title: 'Ready to Vote?',
      content: 'Once you\'ve added enough ideas, click here to start the voting process and finalize your plans.',
