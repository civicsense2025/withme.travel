  ...
  return (
    <main className="min-h-screen flex flex-col bg-gradient-to-br from-background to-muted dark:from-black dark:to-gray-950 relative overflow-hidden font-sans">
      ...
      <div className="flex-1 flex flex-col justify-center items-center p-4">
        <div className="w-full max-w-lg mx-auto flex flex-col items-center py-16">
          ...
          {success ? (
            ...
            <form onSubmit={handleSubmit} className="w-full max-w-sm mx-auto flex flex-col gap-6 mb-10">
          ...
          <div className="w-full max-w-sm mx-auto">
            <h3 className="text-base font-semibold mb-4 text-gray-800 dark:text-gray-200">When you join, you'll get:</h3>
            <ul className="mb-8 w-full text-gray-700 dark:text-gray-300 text-base space-y-4">
              {BENEFITS.map((benefit) => (
                <li key={benefit.text} className="flex items-start gap-3 bg-gray-50 dark:bg-gray-900 border border-gray-100 dark:border-gray-800 p-3 rounded-xl">
      ...
      <footer className="py-6 text-sm text-gray-500 dark:text-gray-400 text-center w-full border-t border-gray-100 dark:border-gray-800">
        Powered by <span className="font-semibold text-primary dark:text-primary-foreground">withme.travel</span>
      </footer>
      <style jsx global>{`
        .animate-float {
        ...
        .animate-subtle-glow {
          box-shadow: 0 0 12px 2px rgba(233, 216, 253, 0.4), 0 0 20px 5px rgba(251, 191, 36, 0.2);
          animation: subtleGlowPulse 3s infinite alternate;
        }
        @keyframes subtleGlowPulse {
          0% { box-shadow: 0 0 12px 2px rgba(233, 216, 253, 0.3), 0 0 20px 5px rgba(251, 191, 36, 0.15); }
          100% { box-shadow: 0 0 20px 4px rgba(233, 216, 253, 0.4), 0 0 28px 8px rgba(251, 191, 36, 0.2); }
        }
      `}</style>
    </main>
  );
