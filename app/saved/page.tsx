      ...
      {isLoading || isLoadingDetails ? (
        ...
        <Tabs defaultValue="all" value={activeTab} onValueChange={setActiveTab} className="mt-8">
              ...
              <div className="mb-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {itineraries.map((itinerary) => (
                    <ItineraryCard key={itinerary.id} itinerary={itinerary} onUnlike={() => {}} />
                  ))}
                </div>
              </div>
            )}
          ...
          <TabsContent value="destinations" className="mt-6">
            ...
            {destinations.length === 0 && (
              <div className="text-center py-12">
                ...
                <p className="text-muted-foreground mt-2">Destinations you save will appear here</p>
              </div>
            )}
          </TabsContent>
          ...
          <TabsContent value="itineraries" className="mt-6">
            ...
            {itineraries.length === 0 && (
              <div className="text-center py-12">
                ...
                <p className="text-muted-foreground mt-2">Itineraries you save will appear here</p>
              </div>
            )}
          </TabsContent>
          ...
          <TabsContent value="attractions" className="mt-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {attractions.map((attraction) => (
                <AttractionCard key={attraction.id} attraction={attraction} onUnlike={() => {}} />
              ))}
            </div>
            {attractions.length === 0 && (
              <div className="text-center py-12">
                <h2 className="text-xl font-semibold">No saved attractions</h2>
                <p className="text-muted-foreground mt-2">Attractions you save will appear here</p>
              </div>
            )}
          </TabsContent>
        </Tabs>
