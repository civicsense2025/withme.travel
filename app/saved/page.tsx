  ...
  return (
    <Card className="overflow-hidden">
      <div className="relative h-40 w-full bg-travel-blue/20">
        <div className="absolute top-3 right-3 z-10">
          <LikeButton itemId={itinerary.id} itemType="itinerary" size="sm" className="shadow-sm" />
        </div>
        {/* Placeholder image */}
  ...
  return (
    <Card className="overflow-hidden">
      <div className="relative h-40 w-full bg-travel-yellow/20">
        <div className="absolute top-3 right-3 z-10">
          <LikeButton itemId={attraction.id} itemType="place" size="sm" className="shadow-sm" />
        </div>
        {/* Placeholder image */}
        <div className="flex items-center justify-center h-full">
