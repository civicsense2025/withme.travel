...
export default function SettingsPage() {
  ...
  const handleSaveProfile = async () => {
    try {
      ...
      console.log('[SettingsPage] Sending profile update request with data:', JSON.stringify(profileToSave));
      ...
      console.log('[SettingsPage] Profile update response:', response.status, JSON.stringify(responseData));
                  ...
                  <>
                    ...
                    <div className="space-y-2">
                      ...
                      <Select
                        ...
                        onValueChange={(value) => 
                          setProfileData(prev => ({ ...prev, travel_personality: value === 'none' ? undefined : value }))
                        }
                      >
                        <SelectTrigger>
                    ...
                    <div className="space-y-2">
                      ...
                      <Select
                        ...
                        onValueChange={(value) => 
                          setProfileData(prev => ({ ...prev, travel_squad: value === 'none' ? undefined : value }))
                        }
                      >
                        <SelectTrigger>
