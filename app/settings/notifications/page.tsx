...
export default function NotificationSettingsPage() {
  const { preferences, updatePreferences, isLoadingPreferences, preferencesError } = useNotifications();
      ...
      <div className="min-h-screen bg-background">
        <main className="container max-w-4xl py-6">
          <div className="bg-red-100 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-md p-4">
            <h2 className="text-xl font-semibold text-red-800 dark:text-red-400">Error Loading Preferences</h2>
  ...
  const handleChannelChange = (channel: 'in_app_enabled' | 'email_enabled' | 'push_enabled', value: boolean) => {
  ...
  const handleTypeChange = (
    type: 'trip_updates' | 'itinerary_changes' | 'member_activity' | 'comments' | 'votes' | 'focus_events',
    value: boolean
  ) => {
    setLocalPreferences(prev => {
      if (!prev) return prev;
  ...
  const saveChanges = async () => {
    ...
    try {
      ...
      setDebugInfo(`Error updating preferences: ${error instanceof Error ? error.message : String(error)}`);
    } finally {
      setSaving(false);
    }
  };
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="bg-muted/50 p-4 rounded-lg flex items-start space-x-3 mt-4">
                  ...
                  <p className="text-sm text-muted-foreground">
                    High priority notifications about trip invitations, security alerts, and upcoming trips
                    will always be delivered via email, regardless of your preferences.
                  </p>
                </div>
              </CardContent>
            </Card>
          ...
          <TabsContent value="content" className="mt-4">
            <Card>
              ...
              <CardContent className="space-y-6">
                <div className="flex items-center justify-between py-4">
                  <div>
                    <Label htmlFor="trip-updates" className="text-base">Trip Updates</Label>
                    <p className="text-sm text-muted-foreground">
                ...
                <div className="flex items-center justify-between py-4">
                  <div>
                    <Label htmlFor="itinerary-changes" className="text-base">Itinerary Changes</Label>
                    <p className="text-sm text-muted-foreground">
                ...
                <div className="flex items-center justify-between py-4">
                  <div>
                    <Label htmlFor="member-activity" className="text-base">Member Activity</Label>
                    <p className="text-sm text-muted-foreground">
                ...
                <div className="flex items-center justify-between py-4">
                  <div>
                    <Label htmlFor="votes" className="text-base">Votes</Label>
                    <p className="text-sm text-muted-foreground">
                ...
                <div className="flex items-center justify-between py-4">
                  <div>
                    <Label htmlFor="focus-events" className="text-base">Focus Sessions</Label>
                    <p className="text-sm text-muted-foreground">
                ...
                <div className="bg-muted/50 p-4 rounded-lg flex items-start space-x-3 mt-4">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Even if you disable certain notification types, you'll still receive direct mentions (@username)
                    and high-priority notifications related to trip invitations and security.
                  </p>
                </div>
              </CardContent>
            </Card>
