      ...
      <Card>
        <CardHeader className="pb-0 border-b">
          <Tabs defaultValue="trips" className="w-full" onValueChange={setActiveTab}>
            <TabsList>
              <TabsTrigger value="trips" variant="travel-purple">
                <div className="flex items-center">
                  <CalendarCheck className="mr-2 h-4 w-4" />
                  My Trips
                </div>
              </TabsTrigger>
              <TabsTrigger value="groups" variant="travel-blue">
                <div className="flex items-center">
                  <Users className="mr-2 h-4 w-4" />
                  My Groups
                </div>
              </TabsTrigger>
              <TabsTrigger value="saved" variant="travel-pink">
                <div className="flex items-center">
            ...
            <TabsContent value="trips" className="px-1">
              <div className="py-4">
                {trips.length > 0 ? (
            ...
            <TabsContent value="groups" className="px-1">
              <div className="py-4">
                <div className="text-center py-8">
                  ...
                  <Button onClick={() => router.push('/groups/create')} variant="secondary">
                    <PlusCircle className="h-4 w-4 mr-2" />
                    Create a Group
                  </Button>
                </div>
            ...
            <TabsContent value="saved" className="px-1">
              <div className="py-4">
