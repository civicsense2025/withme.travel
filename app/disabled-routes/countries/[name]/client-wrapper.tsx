...
export function CountryStatsClientWrapper({ country, destinationsCount }: CountryStatsClientWrapperProps) {
        ...
        <p>
          {stats.local_language ? (
            <>
              ...
              {stats.visa_required ? 'A visa is required for most visitors.' : 'Visa is not required for most visitors.'}
            </>
          ) : (
            <>
