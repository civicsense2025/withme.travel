      ...
      <div className="container mx-auto px-4 py-12">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          ...
          <TabsContent value="overview" className="space-y-10">
            ...
            >
              {/* Highlights */}
              <motion.div variants={itemVariants} className="bg-card p-6 rounded-lg shadow-sm border">
                <h3 className={`text-xl font-semibold mb-4 text-${countryData.accentColor}`}>Highlights</h3>
