  ...
  const tourSteps = [
    {
      ...
      description: "You've successfully created a trip based on your group's ideas! Let's take a quick tour to get you familiar with the trip management tools.",
      icon: <CheckCircle className="h-16 w-16 text-green-500" />,
      image: null
    },
    {
      title: "Trip Overview",
      description: "This is your trip dashboard. Here you can see all the important details at a glance, including dates, destinations, and activities.",
      icon: <MapPin className="h-16 w-16 text-blue-500" />,
      image: "/images/tour/trip-overview.png"
    },
    {
      title: "Trip Itinerary",
      description: "The itinerary section lets you plan your trip day by day. Add activities, accommodations, and transportation all in one place.",
      icon: <Calendar className="h-16 w-16 text-purple-500" />,
      image: "/images/tour/trip-itinerary.png"
    },
    {
      title: "Trip Budget",
      description: "Track your expenses and budget in the budget section. Add costs for accommodations, activities, and transportation.",
      icon: <DollarSign className="h-16 w-16 text-green-500" />,
      image: "/images/tour/trip-budget.png"
    },
    {
      title: "Collaborate with Friends",
      description: "Your trip is fully collaborative! Invite friends to join your trip and plan together in real-time.",
