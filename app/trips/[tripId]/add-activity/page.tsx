...
export default function AddActivityPage() {
  ...
  async function handleAddActivitiesToTrip() {
    ...
    try {
      ...
      const startPosition = maxPositionData && maxPositionData.length > 0
    ...
    return (
      <div className="container py-8">
        <Card className="p-6 bg-red-50">
          ...
          <p className="text-red-600 mb-4">The trip you're looking for doesn't exist or you don't have permission to view it.</p>
          <Button asChild>
        ...
        >
          {isAddingToTrip ? (
            ...
            <>
              ...
              Add {selectedActivities.length} {selectedActivities.length === 1 ? 'Activity' : 'Activities'} to Trip
            </>
          )}
        </Button>
      </div>
