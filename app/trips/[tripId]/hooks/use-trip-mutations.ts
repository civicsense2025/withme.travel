...
export function useTripMutations(tripId: string) {
   ...
   */
  const createSection = async (section: Partial<ItinerarySection>): Promise<MutationResult<ItinerarySection>> => {
    if (!tripId) {
      return { 
        data: null, 
   ...
   */
  const updateSection = async (sectionId: string, updates: Partial<ItinerarySection>): Promise<MutationResult<ItinerarySection>> => {
    if (!tripId || !sectionId) {
      return { 
        data: null, 
   ...
   */
  const createItem = async (item: Partial<ItineraryItem>): Promise<MutationResult<ItineraryItem>> => {
    if (!tripId) {
      return { 
        data: null, 
        error: new Error('No trip ID provided'), 
   ...
   */
  const updateItem = async (itemId: string, updates: Partial<ItineraryItem>): Promise<MutationResult<ItineraryItem>> => {
    if (!tripId || !itemId) {
      return { 
        data: null, 
