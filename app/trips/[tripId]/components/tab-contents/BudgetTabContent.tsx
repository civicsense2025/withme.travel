      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              ...
              {isLoading
                ? '...'
                : (
                    (manualExpenses?.reduce((total, exp) => total + exp.amount, 0) || 0) +
                    (plannedExpenses || 0)
                  ).toFixed(2)}
            </div>
            <p className="text-xs text-muted-foreground">Combined expenses and estimated costs</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              ...
              {isLoading
                ? '...'
                : (manualExpenses?.reduce((total, exp) => total + exp.amount, 0) || 0).toFixed(2)}
            </div>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">From itinerary items</p>
          </CardContent>
        </Card>
      </div>
                ...
                <form onSubmit={handleExpenseSubmit}>
                  <div className="grid gap-4 py-4">
                    ...
                    <div className="grid grid-cols-4 items-center gap-4">
                      ...
                      <div className="col-span-3">
                        <Select
                          value={itineraryItem || 'none'}
                          onValueChange={(value) => setItineraryItem(value === 'none' ? '' : value)}
                        >
                          <SelectTrigger>
                        ...
                        <div className="col-span-3 space-y-2">
                          {members.map((member) => (
                            <div key={member.id} className="flex items-center gap-2">
                              <span className="w-24 truncate">{member.name || member.email}:</span>
                              <Input
                                type="number"
                                min="0"
                                max="100"
