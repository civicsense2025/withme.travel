...
import { QuestionType, type Question, type Response, type ResponseSession } from '@/app/components/feedback/types';
...
export function TripForms({
  ...
  const handleSubmitPreferences = async (data: any) => {
    try {
      ...
      setErrorMessage(error instanceof Error ? error.message : 'An error occurred submitting the form');
    }
  };
  ...
  const canRenderSummary = mockQuestions.length > 0 && 
          ...
          {completedForms.length > 0 ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-muted-foreground mt-2 max-w-md mx-auto">
                When you and your group complete forms, they'll appear here with results and insights.
              </p>
              <Button 
                className="mt-6" 
                onClick={() => { 
