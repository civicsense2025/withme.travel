...
import { 
  Bell, MessageSquare, Lock, Globe, UserPlus, 
  Trash2, CheckSquare, Settings, PenSquare
} from 'lucide-react';
    ...
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Customize how your group works and looks
          </DialogDescription>
        </DialogHeader>
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                <div className="flex items-center space-x-2 col-span-3">
                  <Switch
                    ...
                    onCheckedChange={(checked) => handleSwitchChange('joinRequiresApproval', checked)}
                  />
