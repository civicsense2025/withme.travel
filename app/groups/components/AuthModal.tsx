...
const AuthModal: React.FC<AuthModalProps> = ({ onSignIn, onClose }) => {
  ...
  return (
    <div
      ...
      ref={modalRef}
    >
      <div className="bg-white dark:bg-gray-900 rounded-lg shadow-lg max-w-sm w-full p-6 outline-none" tabIndex={0}>
        <h2 id="auth-modal-title" className="text-xl font-semibold mb-2">Just one more step!</h2>
