...
const steps = [
  ...
  },
  {
    ...
    icon: VoteIcon, // Using the custom component defined below
...
export function IdeaStepper({ currentStep = 1, className }: IdeaStepperProps) {
  return (
          ...
          <React.Fragment key={step.number}>
            ...
            >
              ...
              <div className="text-center mt-2">
                ...
                <p className="text-xs text-gray-500 max-w-[100px] mx-auto">
                  {step.description}
                </p>
              </div>
            </motion.div>
