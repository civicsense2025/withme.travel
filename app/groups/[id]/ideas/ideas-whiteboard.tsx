...
import { useIdeaStore, ColumnId, IdeaPosition, GroupIdea } from './store/idea-store';
...
export default function IdeasWhiteboard({ groupId, groupName, isAuthenticated }: IdeasWhiteboardProps) {
  ...
  if (isReadyForVoting) {
    return <ReadyForVotingModal onClose={() => setIsReadyForVoting(false)} groupId={resolvedGroupId} />;
  }
