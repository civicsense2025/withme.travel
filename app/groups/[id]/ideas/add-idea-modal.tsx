    ...
    <Dialog open onOpenChange={() => onClose()}>
      <DialogContent className="sm:max-w-md z-200 modal-content" onClick={(e) => e.stopPropagation()}>
        <div className="flex items-center justify-between mb-2 border-b border-gray-200 pb-2">
          <DialogTitle className="text-xl font-bold">{editingIdea ? 'Edit Idea' : 'Add New Idea'}</DialogTitle>
          <Button 
            variant="ghost" 
            size="icon" 
        ...
        <form onSubmit={handleSubmit} onClick={(e) => e.stopPropagation()}>
          <div className="grid gap-4 py-2">
            ...
            <div className="grid gap-2">
              <Label htmlFor="type" className="font-medium text-base">Idea Type</Label>
            ...
            {/* Title */}
            <div className="grid gap-2">
              <Label htmlFor="title" className="font-medium text-base">Title</Label>
              <Input
                id="title"
                value={title}
            ...
            {/* Description */}
            <div className="grid gap-2">
              <Label htmlFor="description" className="font-medium text-base">Description (optional)</Label>
              <Textarea
                id="description"
                value={description}
            ...
            <div className="mt-2">
              <Label htmlFor="idea-link" className="block text-xs font-medium text-gray-700 mb-1">Optional Link</Label>
              <Input
                id="idea-link"
                type="url"
                value={link}
