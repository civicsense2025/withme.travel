...
import { Lightbulb, ThumbsUp, ThumbsDown, Plus, ArrowRight, Calendar, DollarSign, MapPin } from 'lucide-react';
...
export default function IdeasPreviewClient({
  ...
  const filteredIdeas = activeTab === 'all' 
    ? initialIdeas 
    : initialIdeas.filter(idea => idea.type === activeTab);
      ...
      <div className="mb-4">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Sign up or log in to contribute to this group
            </CardDescription>
          </CardHeader>
          <CardContent>
