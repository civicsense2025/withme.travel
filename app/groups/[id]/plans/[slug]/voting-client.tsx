  ...
  const getWinningIdeas = () => {
    ...
    Object.entries(ideasByType).forEach(([type, typeIdeas]) => {
      ...
      winners[type] = sortedIdeas.filter(idea => 
        getTotalVotesForIdea(idea) === topScore && topScore > 0
      );
    });
                      ...
                      >
                        <Card className="overflow-hidden">
                          ...
                          <CardFooter className="flex justify-between pt-0">
                            <p className="text-xs text-muted-foreground">
                              Added by {members.find(m => m.user_id === idea.created_by)?.profiles.full_name || 'Guest'}
                            </p>
            ...
            <CardContent>
              <div className="flex flex-wrap gap-4">
                {members.map(member => {
                  ...
                  const hasVoted = member.user_id === currentUserId 
