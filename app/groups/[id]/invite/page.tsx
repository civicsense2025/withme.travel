...
export default async function GroupInvitePage({ params }: { params: { id: string } }) {
  ...
  const membership = group.group_members?.find((m: any) => m.user_id === userId && m.status === 'active');
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-2">Share this link with your friends to invite them to your group.</p>
          </div>
