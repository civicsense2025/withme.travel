...
export default function GroupDetailClient({
  ...
  const handleAddIdea = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Refresh ideas
      const ideasRes = await fetch(`/api/groups/${group.id}/plans/ideas`);
      if (ideasRes.ok) {
    ...
    <Container>
      <div className="py-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Left sidebar with group details and members */}
                  ...
                  {uniqueMembers.map((member) => (
                    <div key={member.user_id} className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="text-sm font-medium">{member.user?.full_name || member.user?.username || 'Unnamed User'}</p>
          ...
          {/* Right content column with tabs, trips, and plans */}
          <div className="md:col-span-2 space-y-6">
            {/* Tabs section - Remove card wrapper */}
            <Tabs defaultValue="overview" value={activeTab} onValueChange={setActiveTab}>
              ...
              <TabsContent value="overview" className="space-y-6">
                {/* Content moved to the right column */}
                <div>
                
                </div>

                {/* Recent Trips - Keep this in the Overview tab but fix button */}
                <div className="mb-8">
                    ...
                    {recentTrips && recentTrips.length > 0 ? (
                      ...
                      <div className="text-center py-10 border border-dashed rounded-lg">
                        ...
                        <p className="text-muted-foreground mb-4">
                          Create a trip to collaborate on destinations, dates, and activities with your group.
                        </p>
                ...
                {/* Recent Plans - Keep this in the Overview tab but fix button */}
                <div>
                  <div className="flex justify-between items-center mb-4">
              ...
              <TabsContent value="ideas">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                    ...
                    <div className="w-full sm:w-auto">
                      <Select
                        ...
                        onValueChange={(value) => setSelectedPlanFilter(value === 'all_plans' ? null : value)}
                      >
                    ...
                    <div className="w-full sm:w-auto">
                      <Select
                        ...
                        onValueChange={(value) => setSelectedTypeFilter(value === 'all_types' ? null : value)}
                      >
                        <SelectTrigger className="min-w-[180px]">
                          <SelectValue />
                        </SelectTrigger>
                  ...
                  {(searchQuery || selectedPlanFilter || selectedTypeFilter) && (
                    <div className="flex flex-wrap gap-2 mt-2">
                      ...
                      {selectedPlanFilter && (
                        <Badge variant="outline" className="flex items-center gap-1">
                          Plan: {selectedPlanFilter === 'null' ? 'Unassigned' : getPlanName(selectedPlanFilter)}
                          <Button 
                            variant="ghost" 
                            size="icon" 
                            className="h-4 w-4 ml-1 p-0" 
                      ...
                      {selectedTypeFilter && (
                        <Badge variant="outline" className="flex items-center gap-1">
                          Type: {selectedTypeFilter.charAt(0) + selectedTypeFilter.slice(1).toLowerCase()}
                          <Button 
                            variant="ghost" 
                            size="icon" 
                            className="h-4 w-4 ml-1 p-0" 
                ...
                {/* Move Dialog outside to avoid button nesting */}
                <Dialog open={newIdeaOpen} onOpenChange={setNewIdeaOpen}>
                  <DialogContent>
                    <DialogHeader>
                      <DialogTitle>Add New Idea</DialogTitle>
                      <DialogDescription>
                        Add a new idea to your group. You can assign it to a specific plan or keep it unassigned.
                      </DialogDescription>
                    </DialogHeader>
                    ...
                    <form onSubmit={handleAddIdea} className="space-y-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <Select 
                          ...
                          onValueChange={(value) => {
                            // Create a new object with updated plan_id to fix the type issue
                            const updatedData = { 
                              ...newIdeaData, 
        ...
        {/* The rest of your modals and dialogs remain unchanged */}
        <GroupSettingsModal 
          group={group}
