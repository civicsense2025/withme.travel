  ...
  features: [
    {
      ...
      description: 'finally, a place to organize everything without endless excel tabs and google docs',
    },
    {
      icon: 'users',
...
// A/B test variants
const abTestVariants: Record<ABTestVariant, Partial<Record<AuthModalContext, Partial<AuthModalContent>>>> = {
