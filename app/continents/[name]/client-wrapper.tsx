    ...
    <div className="space-y-6">
      ...
      <div className="prose max-w-none dark:prose-invert">
        ...
        {stats.description ? (
          ...
          <p>
            {continent} is home to {countriesCount} {countriesCount === 1 ? 'country' : 'countries'} and {destinationsCount} {destinationsCount === 1 ? 'destination' : 'destinations'}, 
            each offering unique experiences for travelers.
          </p>
        )}
        
        {stats.high_season && (
          <p>
            <strong>High Season:</strong> {stats.high_season.charAt(0).toUpperCase() + stats.high_season.slice(1)}
          </p>
        )}
