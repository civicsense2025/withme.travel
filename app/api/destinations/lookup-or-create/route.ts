...
const lookupOrCreateSchema = z.object({
...
export async function POST(request: NextRequest) {
    ...
    try {
        ...
        console.log('[/api/destinations/lookup-or-create] Received body:', JSON.stringify(body, null, 2));
    ...
    try {
        ...
        if (insertError) {
            ...
            if (insertError.code === '23505') { // Unique constraint violation (likely mapbox_id)
