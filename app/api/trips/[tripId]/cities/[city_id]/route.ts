...
export async function GET(
  ...
  try {
    ...
    if (cityError) {
      ...
      return NextResponse.json(
        { error: 'City not found in this trip' },
        { status: 404 }
      );
    }
...
export async function PATCH(
  ...
  try {
    ...
    if (updateError) {
      ...
      return NextResponse.json(
        { error: 'Failed to update city in trip' },
        { status: 500 }
      );
    }
...
export async function DELETE(
  ...
  try {
    ...
    if (sectionsError) {
      ...
      return NextResponse.json(
        { error: 'Failed to process itinerary sections' },
        { status: 500 }
      );
    }
    ...
    if (sections && sections.length > 0) {
      ...
      if (updateSectionsError) {
        ...
        return NextResponse.json(
          { error: 'Failed to update itinerary sections' },
          { status: 500 }
        );
      }
    }
    ...
    if (deleteError) {
      ...
      return NextResponse.json(
        { error: 'Failed to remove city from trip' },
        { status: 500 }
      );
    }
