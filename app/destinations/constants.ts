...
export const SEO = {
  ...
  DESCRIPTION:
    'Explore authentic local experiences and hidden gems in cities around the world, curated by fellow travelers.',
  KEYWORDS:
    'travel destinations, city guides, adventure travel, local experiences, travel planning',
};
