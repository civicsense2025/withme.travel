    ...
    <div className="container max-w-5xl mx-auto py-16 px-4">
      ...
      <div className="mt-16 p-6 border rounded-lg bg-surface-light/50">
        ...
        <div className="prose dark:prose-invert max-w-none">
          <p>
            This editor is implemented using the <a href="https://tiptap.dev/" target="_blank" rel="noopener noreferrer">TipTap</a> editor 
            framework which is built on top of <a href="https://prosemirror.net/" target="_blank" rel="noopener noreferrer">ProseMirror</a>.
          </p>
          <p>
            Key features:
          </p>
