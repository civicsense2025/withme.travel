...
interface TripPreferenceFormProps {
  ...
  onSubmit: (responses: { formId: string; responses: { questionId: string; value: any }[] }) => Promise<void>;
}
...
export function TripPreferenceForm({
  ...
  const form: FeedbackForm = {
    ...
    completionMessage: "Thanks for sharing your preferences! We'll use these to make this trip amazing.",
  ...
  const questions: Question[] = [
    // Welcome screen
    {
      ...
      description: "Answer a few quick questions to help us create a trip everyone will love. This should take less than 3 minutes.",
    ...
    // Budget range slider
    {
      ...
      description: "Drag the slider to indicate your overall budget for this trip (not including flights).",
    ...
    // Activity interest levels
    {
      ...
      description: "Rate your interest in each activity type (1 = not interested, 5 = very interested)",
    ...
    // Trip priorities ranking
    {
      ...
      description: "Drag items to rearrange them from most important (top) to least important (bottom)",
    ...
    // Thank you screen
    {
      ...
      description: "We'll use these insights to help plan a trip that everyone will love. You can always update your preferences later.",
