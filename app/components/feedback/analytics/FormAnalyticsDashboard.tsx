            ...
            <TabsContent value="responses" className="space-y-6">
              <Card>
                ...
                <CardContent className="h-80">
                  ...
                  <div className="flex items-center justify-center h-full text-muted-foreground">
                    ...
                    <br />showing trends in submission volume over time
                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    What devices people use to complete the form
                  </CardDescription>
                </CardHeader>
                <CardContent className="h-80">
                  ...
                  <div className="flex items-center justify-center h-full text-muted-foreground">
                    ...
                    <br />showing the breakdown of mobile, tablet, and desktop users
                  </div>
                </CardContent>
              </Card>
            </TabsContent>
