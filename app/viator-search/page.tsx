...
import { ViatorExperienceProps } from '@/components/viator/ViatorExperienceCard';
...
export default function ViatorSearchPage() {
  ...
  const popularDestinations: PopularDestination[] = [
    { id: '737', name: 'Paris', imageUrl: 'https://images.unsplash.com/photo-1549144511-f099e773c147' },
    { id: '662', name: 'Rome', imageUrl: 'https://images.unsplash.com/photo-1552832230-c0197dd311b5' },
    { id: '503', name: 'London', imageUrl: 'https://images.unsplash.com/photo-1533929736458-ca588d08c8be' },
    { id: '687', name: 'New York', imageUrl: 'https://images.unsplash.com/photo-1496442226666-8d4d0e62e6e9' },
    { id: '684', name: 'Barcelona', imageUrl: 'https://images.unsplash.com/photo-1523531294919-4bcd7c65e216' },
    { id: '524', name: 'Tokyo', imageUrl: 'https://images.unsplash.com/photo-1536098561742-ca998e48cbcc' },
  ];
  ...
  const mockPopularExperiences: ViatorExperienceProps[] = [
    ...
    },
    {
      ...
      description: 'Bypass the queue and explore the Colosseum, Roman Forum, and Palatine Hill on this guided tour.',
    ...
    },
    {
      ...
      description: 'Visit Barcelona\'s most famous landmark, the Sagrada Familia, without waiting in line.',
    ...
    },
    {
      ...
      description: 'Enjoy priority boarding and skip the lengthy queue with a fast-track ticket to the London Eye.',
    ...
    },
    {
      ...
      description: 'Experience breathtaking views of Manhattan from the Top of the Rock Observation Deck.',
  ...
  const [filteredExperiences, setFilteredExperiences] = useState<ViatorExperienceProps[]>(mockPopularExperiences);
  const [selectedCategory, setSelectedCategory] = useState<string>('');
  const [sortOption, setSortOption] = useState('popularity');
  
  useEffect(() => {
    // Simulate API call for filtering and sorting
    setIsLoading(true);
    ...
    setTimeout(() => {
      ...
      if (selectedDestination) {
        const destName = popularDestinations.find(d => d.id === selectedDestination)?.name || '';
        results = results.filter(exp => exp.location.includes(destName));
      }
      ...
      if (selectedCategory) {
        results = results.filter(exp => 
          exp.labels?.some(label => 
            label.toLowerCase() === selectedCategory.toLowerCase()
          )
        );
      }
  ...
  }, [selectedDestination, selectedCategory, sortOption, searchQuery]);
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-8">
        ...
        <TabsContent value="popular" className="space-y-8">
          <ViatorExperienceGrid
            ...
            experiences={mockPopularExperiences}
        ...
        <TabsContent value="search" className="space-y-8">
          <div className="flex flex-col justify-between gap-4 md:flex-row">
            <h2 className="text-2xl font-bold">
              ...
              {selectedDestination && ` in ${popularDestinations.find(d => d.id === selectedDestination)?.name}`}
            </h2>
