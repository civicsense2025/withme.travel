...
export default function ViatorDemoPage() {
  ...
  const sampleExperiences = [
    ...
    },
    {
      ...
      description: 'Save time and money with this Paris Museum Pass and skip-the-line Louvre ticket.',
      ...
      <div className="mb-10 grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3">
        <Link href="/viator-search" className="block">
          <Card className="h-full transition-all hover:shadow-lg">
            <CardContent className="flex h-full flex-col items-center justify-center p-6">
              ...
              <p className="text-center text-secondary-text">Browse and search from thousands of tours and activities</p>
            </CardContent>
          </Card>
        </Link>
        ...
        <Link href="/viator-demo/bookings" className="block">
          <Card className="h-full transition-all hover:shadow-lg">
            <CardContent className="flex h-full flex-col items-center justify-center p-6">
              ...
              <p className="text-center text-secondary-text">View examples of the booking flow and management interface</p>
            </CardContent>
          </Card>
        </Link>
        ...
        <Card className="h-full">
          <CardContent className="flex h-full flex-col items-center justify-center p-6">
            ...
            <p className="text-center text-secondary-text">View individual Viator components in action</p>
          ...
          <div className="space-y-8">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  This demonstrates how the Viator integration would work in the itinerary tab's quick add section.
                </CardDescription>
              </CardHeader>
              <CardContent>
                          ...
                          <CardContent className="p-4">
                            <div className="flex items-start justify-between">
                              <div>
                                ...
                                {exp.data && (
                                  <div className="mt-2">
                                    <p className="text-sm">Price: {exp.data.price} • Duration: {exp.data.duration}</p>
                                  </div>
                                )}
                              </div>
                              {exp.data?.imageUrl && (
