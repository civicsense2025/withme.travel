      ...
      <Tabs defaultValue="bookings">
          ...
          <Card>
            ...
            <CardContent>
              <p className="mb-6 text-secondary-text">
                This shows how users can view and manage their Viator bookings across all their trips in one consolidated view.
              </p>
        ...
        <TabsContent value="detail">
          <Card>
            ...
            <CardContent>
              <p className="mb-6 text-secondary-text">
                This demonstrates how a Viator experience appears in the itinerary with different booking statuses.
                Click "Book Now" to see the booking confirmation state.
              </p>
