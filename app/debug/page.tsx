    ...
    <div className="container mx-auto p-4 max-w-5xl">
      ...
      <div className="mb-8 bg-blue-50 border border-blue-200 rounded-md p-4 text-blue-700 text-sm flex items-start">
        ...
        <div>
          ...
          <p className="mt-1">
            These tools are only available in development mode and help diagnose issues with the application.
            Use them to check system status, verify authentication, and test components.
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Card>
          <CardHeader className="pb-2">
            ...
            <CardDescription>
              Debug authentication state and test user flows
            </CardDescription>
          </CardHeader>
          <CardContent>
      ...
      <div className="mt-8 text-sm text-gray-500">
        <p>
          Debug tools are only available in development mode and should not be exposed in production.
        </p>
      </div>
    </div>
  );
