    ...
    <div className="container mx-auto p-4 max-w-5xl">
      <div className="flex items-center mb-6">
        ...
        <div className="ml-auto">
          <Button onClick={resetDemoState} variant="outline" className="flex items-center">
      ...
      <div className="mb-6 bg-blue-50 border border-blue-200 rounded-md p-4 text-blue-700 text-sm flex items-start">
        ...
        <div>
          ...
          <p className="mt-1">
            ...
            <code>@/components/debug</code> directory. Use these tools to debug UI components,
            layout issues, and state management problems.
          </p>
        </div>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
        <Card>
          <CardHeader className="pb-2">
            ...
            <CardDescription>Available debugging tools</CardDescription>
          </CardHeader>
        ...
        <Card>
          <CardHeader className="pb-2">
            ...
            <CardDescription>Interactive state for examples</CardDescription>
          </CardHeader>
          <CardContent className="pt-0">
            <StateInspector
