...
import { ArrowLeft, ExternalLink, RefreshCw, CheckCircle, XCircle, AlertCircle } from 'lucide-react';
    ...
    <div className="container mx-auto p-4 max-w-5xl">
      ...
      <div className="mb-6 bg-blue-50 border border-blue-200 rounded-md p-4 text-blue-700 text-sm flex items-start">
        ...
        <div>
          ...
          <p className="mt-1">
            This page displays system status, environment information, and API health checks.
            Use this to diagnose issues with the application's core services and configuration.
          </p>
        </div>
      </div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className={`p-4 rounded-md ${systemInfo.auth.session ? 'bg-green-50 border border-green-200' : 'bg-gray-50 border border-gray-200'}`}>
                    <h3 className="text-lg font-medium mb-2">User Session</h3>
                    <p>{systemInfo.auth.session ? 'User is authenticated' : 'No active user session'}</p>
                    <div className="mt-4">
                  ...
                  <div className={`p-4 rounded-md ${systemInfo.auth.guestToken ? 'bg-green-50 border border-green-200' : 'bg-gray-50 border border-gray-200'}`}>
                    <h3 className="text-lg font-medium mb-2">Guest Token</h3>
                    <p>{systemInfo.auth.guestToken ? 'Guest token is present' : 'No guest token'}</p>
