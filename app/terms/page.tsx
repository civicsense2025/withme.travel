  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-3xl">
      ...
      <div className="prose dark:prose-invert max-w-none">
        <p>
          Welcome to withme.travel. Please read these Terms of Service carefully before using our
          platform. By accessing or using withme.travel, you agree to be bound by these Terms.
        </p>

        <h2>1. Acceptance of Terms</h2>
        <p>
          By creating an account or using any part of withme.travel, you agree to these Terms of
          Service and our Privacy Policy. If you do not agree to these Terms, you may not access or
          use our services.
        </p>

        <h2>2. Description of Service</h2>
        <p>
          withme.travel provides a collaborative travel planning platform that allows users to
          create, share, and manage group trips. We reserve the right to modify, suspend, or
        ...
        <p>
          You retain ownership of content you submit to withme.travel. By submitting content, you
          grant us a worldwide, non-exclusive, royalty-free license to use, reproduce, modify,
          adapt, publish, and display such content in connection with providing and promoting our
          services.
        </p>
        ...
        <p>
          ...
          controlled by withme.travel. We have no control over, and assume no responsibility for,
        ...
        <p>
          ...
          prior notice, for conduct that we determine violates these Terms or is harmful to other
        ...
        <p>
          To the maximum extent permitted by law, withme.travel shall not be liable for any
        ...
        <p>
          These Terms shall be governed by the laws of the jurisdiction in which withme.travel is
