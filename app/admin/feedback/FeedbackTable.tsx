...
export default function FeedbackTable({ initialData }: FeedbackTableProps) {
  ...
  const columns = [
    ...
    },
    {
      ...
      sortable: true,
      cell: (value: string) => (
        <Badge className={`${feedbackTypeColors[value as keyof typeof feedbackTypeColors] || feedbackTypeColors.other}`}>
          {value.replace('_', ' ')}
        </Badge>
      ),
    },
    {
      ...
      sortable: true,
      cell: (value: string) => (
        <Badge className={`${feedbackStatusColors[value as keyof typeof feedbackStatusColors] || feedbackStatusColors.new}`}>
          {value.replace('_', ' ')}
        </Badge>
      ),
    },
  ...
  const bulkActions = [
    ...
    },
    {
      ...
      confirmationMessage: 'Are you sure you want to delete the selected feedback items? This cannot be undone.',
    },
  ];
