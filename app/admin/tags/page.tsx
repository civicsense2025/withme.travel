...
import { Tag, TagSuggestion } from '@/hooks/use-tags'
...
interface TagWithSuggestion extends Tag {
...
export default function AdminTagsPage() {
  ...
  async function loadTags() {
    try {
      ...
      setPendingTags((suggestions || []).map((s: SuggestionData) => ({
        ...s.tag,
        suggestion: {
          id: s.id,
          tag_id: s.tag_id,
  ...
  async function handleReject(suggestion: TagSuggestion, reason: string = 'Rejected by admin') {
    try {
      setIsLoading(true)
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex items-center gap-2">
                            <Button
                              ...
                              size="sm"
                              className="gap-1"
                              onClick={() => handleApprove(tag.suggestion)}
                            >
                            ...
                            <Button
                              ...
                              size="sm"
                              className="gap-1"
                              onClick={() => handleReject(tag.suggestion)}
                            >
                              <X className="h-4 w-4" />
                              Reject
                            </Button>
