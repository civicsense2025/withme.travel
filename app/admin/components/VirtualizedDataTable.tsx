...
export function VirtualizedDataTable<T>({
  ...
  const processedData = useMemo(() => {
    ...
    return result;
  }, [data, columns, searchTerm, filters, sortField, sortDirection]);
                  ...
                  >
                    ...
                    <SelectContent>
                      {filterableColumns.map((column) => (
                        <SelectItem key={column.accessor as string} value={column.accessor as string}>
                          {column.header}
                        </SelectItem>
                      ))}
                    </SelectContent>
                  ...
                  {[...Array(pageCount)].map((_, i) => {
                    ...
                    if (!shouldShowPageNumber) {
                      ...
                      if (i === 1 || i === pageCount - 2) {
                        return <span key={i} className="px-3 py-2 text-gray-500 dark:text-gray-400">...</span>;
                      }
                      return null;
                    }
