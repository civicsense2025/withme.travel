...
const CONTENT_TYPES: ContentType[] = [
  {
    ...
    template: 'name,description,category,address,latitude,longitude,price_level,rating,website,phone_number',
    sampleData: 'Grand Central Terminal,Historic terminal and transportation hub,landmark,"89 E 42nd St, New York, NY 10017",40.7527,-73.9772,2,4.5,https://www.grandcentralterminal.com,+12123402583',
  ...
  },
  {
    ...
    sampleData: 'Barcelona,barcelona,Spain,"Barcelona is a vibrant city known for its architecture",Europe',
  ...
  },
  {
    ...
    sampleData: 'Sagrada Familia Tour,Guided tour of this iconic building,attractions,barcelona-123,120,25.99',
    ...
    try {
      ...
      if (result.success) {
        toast({
          ...
          description: result.message || `Successfully imported ${result.insertedItems?.length || 0} ${contentType.name.toLowerCase()}.`,
        });
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Import or export {CONTENT_TYPES.find(type => type.id === selectedContentType)?.name.toLowerCase()} data in bulk
        </CardDescription>
      </CardHeader>
                ...
                <>
                  ...
                  {contentType && (
                    <Alert>
                      ...
                      <AlertDescription>
                        The following fields are required: <span className="font-semibold">{contentType.requiredFields.join(', ')}</span>
                      </AlertDescription>
                    </Alert>
                  )}
                </>
            ...
            <TabsContent value="export" className="space-y-4 mt-0">
              ...
              <Alert>
                ...
                <AlertDescription>
                  ...
                  {parentId ? ' for the current parent item' : ''} in {exportFormat.toUpperCase()} format.
                </AlertDescription>
              </Alert>
            </TabsContent>
          </div>
        ...
        <div className="flex space-x-2">
          ...
          {activeTab === 'import' ? (
            <Button 
              ...
              disabled={!selectedFile || isLoading || !!importResult}
            >
              {isLoading ? (
                <>
