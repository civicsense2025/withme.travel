...
export default function AuthModalAdminPage() {
  ...
  const prepareChartData = () => {
    ...
    const conversionData = Object.entries(analyticsData.conversionByVariant).map(([name, data]) => ({
      name,
      opens: data.opens,
        ...
        <TabsContent value="analytics" className="space-y-6 mt-4">
          {analyticsData ? (
            <>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <Card>
                  ...
                  <CardContent>
                    <p className="text-3xl font-bold">{Object.keys(analyticsData.contextCounts).length}</p>
                  </CardContent>
                </Card>
                ...
                <Card>
                  ...
                  <CardContent>
                    {Object.entries(analyticsData.conversionByVariant)
            ...
            <Card>
              ...
              <CardContent>
                <p>There is no analytics data available yet. Try testing the auth modal to generate some data.</p>
              </CardContent>
            </Card>
          )}
        </TabsContent>
