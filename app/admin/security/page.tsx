  ...
  return (
    <Container>
      ...
      <Alert className="mb-8 border-amber-500 bg-amber-50 dark:bg-amber-950/20">
        ...
        <AlertDescription>
          Changes to security settings can significantly impact the platform. Always review changes carefully.
        </AlertDescription>
      </Alert>
      ...
      <Tabs defaultValue="administrators" className="w-full">
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-gray-500 mb-4">
                This section allows you to view and manage admin users.
                You can grant or revoke admin privileges from users.
              </p>
              <div className="flex justify-end">
                <Button variant="outline" className="mr-2">View Admins</Button>
        ...
        <TabsContent value="rls">
          <Card>
            ...
            <CardContent>
              <p className="text-gray-500 mb-4">
                Review and manage row-level security policies across tables.
                RLS policies enforce data access controls at the database level.
              </p>
              <div className="flex justify-end">
                <Button variant="outline" className="mr-2">View Policies</Button>
        ...
        <TabsContent value="auth">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Configure login and registration options
              </CardDescription>
            </CardHeader>
            <CardContent>
              <p className="text-gray-500 mb-4">
                Manage authentication settings including email templates,
                social providers, and security policies.
              </p>
              <div className="flex justify-end">
                <Button variant="outline" className="mr-2">View Settings</Button>
        ...
        <TabsContent value="audit">
          <Card>
            ...
            <CardContent>
              <p className="text-gray-500 mb-4">
                View audit logs for security-related actions across the platform.
                Logs track admin actions, authentication events, and critical changes.
              </p>
              <div className="flex justify-end">
