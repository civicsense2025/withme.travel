...
export default function ItineraryTemplateEditor({ template, sections: initialSections }: ItineraryTemplateEditorProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col space-y-2">
        <div>
          <Link href="/admin/itineraries" className="text-sm text-blue-600 hover:text-blue-800 flex items-center">
          ...
          <div className="flex items-center gap-3">
            <div className="flex items-center space-x-2">
              ...
              <Label htmlFor="published">
                {templateData.is_published ? 'Published' : 'Draft'}
              </Label>
            </div>
            <Button
        ...
        <TabsContent value="basic-info">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Basic information about this itinerary template
              </CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between">
              <div>
                ...
                <CardDescription>
                  Organize your template into days and sections
                </CardDescription>
              </div>
              <Button>
                              ...
                              <div className="flex items-center justify-between mb-3">
                                <div className="flex items-center">
                                  ...
                                  <div>
                                    ...
                                    <p className="text-sm text-muted-foreground">
                                      Day {section.day_number} • {section.template_items.length} items
                                    </p>
                                  </div>
                                </div>
                    ...
                    <div className="space-y-6">
                      {sections.map((section) => (
                        <div key={section.id} className="border-t pt-4">
                          <h3 className="font-bold">Day {section.day_number}: {section.title}</h3>
                          {section.description && (
