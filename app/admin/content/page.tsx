    ...
    <Container>
      <div className="mb-8">
        ...
        <p className="text-gray-500 mt-2">
          Manage all content on the withme.travel platform
        </p>
      </div>
      ...
      <Tabs defaultValue="cities" className="w-full">
        ...
        <TabsContent value="cities">
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
            <p className="text-gray-500">
              Cities management interface will be available here. 
              This will include the ability to add, edit, and delete cities.
            </p>
          </div>
        </TabsContent>
        ...
        <TabsContent value="destinations">
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
            <p className="text-gray-500">
              Destinations management interface will be available here.
              This will include the ability to add, edit, and delete destinations.
            </p>
          </div>
        </TabsContent>
        ...
        <TabsContent value="templates">
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
            <p className="text-gray-500">
              Itinerary templates management interface will be available here.
              This will include the ability to add, edit, and delete templates.
            </p>
          </div>
        </TabsContent>
        ...
        <TabsContent value="validation">
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
            <p className="text-gray-500">
              Content validation tools will be available here.
              This will include checking for missing data, broken links, and other quality issues.
            </p>
          </div>
        </TabsContent>
      </Tabs>
