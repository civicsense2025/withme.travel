  ...
  return (
    <div className="container py-6">
      ...
      <Card className="mb-6">
        ...
        <CardContent>
          <p className="mb-4">
            This page lets you manage all media assets in the system. You can:
          </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <Card>
          ...
          <CardContent>
            <p className="mb-4">
              Browse, search, and manage all images currently in the system.
            </p>
            <Button onClick={() => setIsMediaLibraryOpen(true)}>
              Open Media Library
            </Button>
        ...
        <Card>
          ...
          <CardContent>
            <p className="mb-4">
              Add new images from Unsplash, Pexels, or upload your own.
            </p>
